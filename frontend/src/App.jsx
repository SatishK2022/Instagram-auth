    ...
    <>
      {loading ? (
        ...
        <svg
          aria-hidden="true"
          role="status"
          className="inline w-20 h-20 mr-3 text-gray-200 animate-spin"
          viewBox="0 0 100 101"
          fill="none"
        ...
        <div className="h-screen bg-slate-900 text-white flex items-center justify-center">
          <div>
            ...
            <div className="py-10 w-full flex flex-col items-center gap-2 border border-orange-500 my-5 rounded-lg">
              <img
              ...
              <p className="text-sm text-zinc-400">{userData.bio}</p>
              <p>{userData.email}</p>
            </div>
          </div>
          <button
